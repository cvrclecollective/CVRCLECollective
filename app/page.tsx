          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-16 md:mb-32 items-center">
              ...
              <div className="flex justify-center items-center mt-12 md:mt-0">
                <div className="w-48 h-48 md:w-64 md:h-64 border border-[#fef9c3]/80 rounded-full flex items-center justify-center relative animate-[pulse_8s_infinite]">
                  <div className="absolute inset-0 border border-[#fef9c3]/40 rounded-full scale-110"></div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      ...
      <div className="relative group flex justify-center items-center mt-12 md:mt-0">
        <div className="relative w-full max-w-[280px] md:max-w-[320px]">
          ...
          {/* Floating Label */}
          <div className="absolute bottom-7 left-2 md:-left-5 bg-black/40 border border-[#D6D4A1]/20 p-3 max-w-[160px] z-20">
